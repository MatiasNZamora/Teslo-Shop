...
export const Pagination = ({ totalPages }: Props) => {
    ...
    // si se escribe en la url una pagina que no es un numero, se redirige a la pagina 1
            ...
            <nav aria-label="Page navigation example">
                <ul className="flex list-style-none">
                    ...
                    <li className="page-item ">
                        <Link
                            className="ppage-link relative block py-1.5 px-3 border-0 bg-transparent outline-none transition-all duration-300 rounded text-gray-800 hover:text-gray-800 hover:bg-gray-200 focus:shadow-none"
